<template>
    <div class="flex flex-col items-center gap-2">
        ...
        <div v-if="recipeStore.recipes == null || recipeStore.recipes.length == 0" class="flex flex-col items-center gap-5">
                ...
                <TransitionGroup class="grid gap-2" name="list" tag="div" @before-leave="beforeLeave">
                    <div v-for="recipe in recipeStore.recipes" :key="recipe.id"
                        ...
                        <div class="flex gap-2">
                            ...
                            <button @click="recipeToDelete = recipe.id; showDeleteModal = true;"
